...
function buscar_en_medlineplus($termino_busqueda) {
  ...
  $url = "https://connect.medlineplus.gov/service?mainSearchCriteria.v.c=195967001&mainSearchCriteria.v.cs=2.16.840.1.113883.6.96&mainSearchCriteria.v.dn=&informationRecipient.languageCode.c=es&knowledgeResponseType=application%2Fjson";
  $ch = curl_init();
